...
//****************************************Recuperer toutes les informations du site de météo france***********************************************************************************    
    ...
    public void telechargement(String jour, String mois, String annee) throws IOException {
        ...
        File file = new File ( "C:\\Users\\Chakib\\Desktop\\téléchargement dossier\\synop." + annee + mois + ".csv.gz" );
    ...
    public void Ouvrir_fichier(String jour,String mois, String annee) {
        ...
        String gzipFile = "C:\\Users\\Chakib\\Desktop\\téléchargement dossier\\synop." + annee  + mois  + ".csv.gz";
        String newFile = "C:\\Users\\Chakib\\Desktop\\téléchargement dossier\\synop." + annee  + mois  + ".csv";
